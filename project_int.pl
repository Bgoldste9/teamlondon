...
while ($programFlag == 0) {
    while ($mainFlag == 0) {
        ...
        print "\n";
        print "Question Set 2: What violation had the highest/lowest percentage in change a specific Province/City?\n";
        print "\n";
        print "Question Set 3: What are the top n locations with the highest/lowest rate of a violation in a year.\n";
        print "\n";
        print "Question Set 4: What are the top n locations with the highest/lowest percent change of a violation between two years.\n";
        print "\n";
